...
// Shared input literals and explicit protocol expectations, not a parser oracle.
inline std::vector<Rejection> rejections() {
    const std::string head="GET / HTTP/1.1\r\nHost: a\r\n";
    std::string over=head+"X: ";
    over.append(16385-over.size()-4,'x');over+="\r\n\r\n";
    return {
        {"G01-invalid-line","GET  / HTTP/1.1\r\nHost: a\r\n\r\n",400},
        {"G02-missing-host","GET / HTTP/1.1\r\nX: a\r\n\r\n",400},
        {"G02-header-after-close",head+"Connection: close\r\nBad Header: x\r\n\r\n",400},
        {"G03-framing-before-405","POST / HTTP/1.1\r\nHost: a\r\nContent-Length: 1\r\n\r\n",400},
